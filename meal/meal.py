## Suppose that you’re in a country where it’s
#  customary to eat breakfast between 7:00 and 8:00,
#  lunch between 12:00 and 13:00, and dinner between 18:00
#  and 19:00. Wouldn’t it be nice if you had a program that could tell you what to eat when?
...
def convert(time):
    min_to_hour = 0
    min_to_hour = int(time[1]) / 60
    hours = int(time[0]) + min_to_hour
    #print(hours)
    return hours
